...
<template>
  <div class="holder">
    <div class="audio green-audio-player">
      ...
      <div class="play-pause-btn" @click="toggle">
        <Transition mode="out-in">
          <svg xmlns="http://www.w3.org/2000/svg" width="18" height="24" viewBox="0 0 18 24" v-if="player.paused">
            <path fill-rule="evenodd" d="M8.5 8.64L13.77 12L8.5 15.36V8.64M6.5 5v14l11-7" />
          </svg>
          <svg xmlns="http://www.w3.org/2000/svg" width="18" height="24" viewBox="0 0 18 24" v-else>
        ...
        <div class="controls" v-else>
          ...
          <div class="slider">
            <div ref="progress" class="progress">
              <div class="pin" ref="pin" @mousedown="dragMouseDown"></div>
            </div>
          </div>
        </div>        
      </Transition>
